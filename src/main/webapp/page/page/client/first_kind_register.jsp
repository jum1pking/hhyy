	...
	<body>
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="cffk.firstKindId" value=""
							   class="INPUT_STYLE1" id="firstKindId">
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2">
						<input type="text" name="cffk.firstKindName" value=""
							class="INPUT_STYLE1" id="firstKindName">
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2">
						<textarea name="cffk.firstKindSalaryId" rows="4"
							class="TEXTAREA_STYLE1" id="firstKindSalaryId"></textarea>
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2">
						<textarea name="cffk.firstKindSaleId" rows="4"
							class="TEXTAREA_STYLE1" id="firstKindSaleId"></textarea>
					</td>
				</tr>
			</table>
			...
			<script>
				function save() {
					...
					if ($("#firstKindId").val()===""||$("#firstKindName").val()===""||$("#firstKindSalaryId").val()===""||$("#firstKindSaleId").val()===""){
						...
						$.ajax({
							type:"get",
							url:"${pageContext.request.contextPath}/client/firstAdd?first_kind_id="+$("#firstKindId").val()+"&first_kind_name="+$("#firstKindName").val()+"&first_kind_salary_id="+$("#firstKindSalaryId").val()+"&first_kind_sale_id="+$("#firstKindSaleId").val(),
